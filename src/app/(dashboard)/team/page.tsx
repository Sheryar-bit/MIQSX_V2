                ...
                {pending.map((i) => (
                  <div key={i._id} className="tm-row" style={rowStyle}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <button onClick={() => revokeInvite(i._id)} style={{ background: "none", border: "none", color: "var(--red)", fontFamily: "'JetBrains Mono', monospace", fontSize: 11, cursor: "pointer", padding: 0 }}>
                        Revoke
                      </button>
                    </div>
                  </div>
