...
const tools = [
  {
    ...
    desc: "Compose vector-first SVG logos from your Brand DNA. Export SVG, PNG, PDF.",
    badge: "Vector-first",
  ...
  },
  {
    ...
    icon: ImageIcon,
    title: "Post Imagery",
    desc: "FLUX-powered brand imagery with style filters: Realism, Neon, Minimalist, Vintage, 3D, and more.",
    badge: "FLUX AI",
  ...
  },
  {
    ...
    desc: "Eid, Ramadan, and 14 August logo variants — seasonal flair validated against your Brand DNA.",
    badge: "Desi",
