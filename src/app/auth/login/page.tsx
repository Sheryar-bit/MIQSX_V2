            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "clamp(28px, 5vh, 60px) 0" }}>
              <div style={{ width: "100%", maxWidth: 408, margin: "0 auto" }}>
                ...
                <h1 data-reveal="" style={{ fontFamily: "'General Sans'", fontWeight: 600, fontSize: "clamp(30px, 3.4vw, 42px)", lineHeight: 1.04, letterSpacing: "-0.03em", margin: "0 0 10px" }}>
                  Good to see{" "}
                  <span style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic", fontWeight: 400, color: "var(--sig)" }}>you again.</span>
                </h1>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 13 }}>
                  ...
                  <label data-reveal="" style={{ display: "block" }}>
                    <span style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                      ...
                      <Link href="/auth/forgot-password" style={{ fontSize: 12, color: "var(--terra)", textDecoration: "none" }}>Forgot?</Link>
                    </span>
                ...
                <p data-reveal="" style={{ textAlign: "center", fontSize: 14, color: "var(--muted)", margin: "24px 0 0" }}>
                  New to MIQSX?{" "}
                  <Link href="/auth/signup" style={{ fontFamily: "'General Sans'", fontWeight: 600, fontSize: 14, color: "var(--sig)", textDecoration: "underline", textUnderlineOffset: 3 }}>
                    Create one
                  </Link>
                </p>
