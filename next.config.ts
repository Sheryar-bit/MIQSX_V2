...
const csp = [
  ...
  "connect-src 'self' https://*.upstash.io https://fonts.googleapis.com https://fonts.gstatic.com https://api.fontshare.com https://api.groq.com https://api.cloudflare.com",
